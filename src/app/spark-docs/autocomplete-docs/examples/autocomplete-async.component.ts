...
@Component({
  selector: 'sprk-autocomplete-example-async',
  template: `
  <sprk-autocomplete (itemSelectedEvent)="selectItem($event)">
    <sprk-input-container>
      <label id="autocomplete-async-label" for="autocomplete-async-input" hasIcon="true" sprkLabel>
        Search for a Fruit
      </label>
      <div class="sprk-b-TextInputIconContainer" aria-labelledby="autocomplete-async-label" role="combobox"
    ...
    <span sprkFieldError id="autocomplete-async--error-container">
    </span>
  </sprk-autocomplete>
  `,
})
export class AutocompleteExampleAsyncComponent {
